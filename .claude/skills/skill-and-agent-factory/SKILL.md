...
Use the `/create-skill` workflow. See [create-skill SKILL.md](${CLAUDE_SKILL_DIR}/../create-skill/SKILL.md) for the full process.

### Agents → `.claude/agents/<name>.md`
Use the `/create-agent` workflow. See [create-agent SKILL.md](${CLAUDE_SKILL_DIR}/../create-agent/SKILL.md) for the full process.
